defmodule ExaultedRoller.Dice.SuccessDicePool do
  ...
  def changeset(%__MODULE__{} = table, attrs) do
    ...
    |> validate_subset(:double, 1..10, message: "must contain only 1 through 10")
    |> validate_subset(:reroll_once, 1..10, message: "must contain only 1 through 10")
    |> validate_subset(:reroll_none, 1..10, message: "must contain only 1 through 10")
  end
end
